    ...
    products: [
      {
        ...
        description:
          "A velvety, creamy broth with delicious real chicken and vegetables, crafted without by-products or fillers.",
        image: "chicken-vegetables-creamy-broth.png"
      },
      {
        title: "Tuna 'N Vegetables",
        description:
          "A velvety, creamy broth with delicious real tuna and vegetables, crafted without by-products or fillers.",
        image: "tuna-vegetables-creamy-broth.png"
      },
      {
        title: "Mackerel 'N Vegetables'",
        description:
          "A delicious, creamy broth with real pieces of mackerel and vegetables, crafted without by-products or fillers.",
